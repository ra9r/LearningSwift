...
extension View {
    ...
    @ViewBuilder public func `if`<Content: View>(_ conditional: Bool, @ViewBuilder _ content: (Self) -> Content) -> some View {
        if conditional {
            content(self)
        } else {
            self
    ...
    @ViewBuilder public func `if`<Truthy: View, Falsy: View>(
    ...
    @ViewBuilder public func iflet<Content: View, T>(_ conditional: Optional<T>, @ViewBuilder _ content: (Self, _ value: T) -> Content) -> some View {
